    ...
    <div className="mt-10 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            <div className="relative group overflow-hidden rounded-2xl p-[1px]">
              ...
              <div className="glass h-full relative bg-[#050812]/90 border border-sky-500/20 p-5 rounded-2xl hover:bg-sky-500/10 transition-all cursor-default">
                ...
                <p className="text-xs text-slate-300 leading-relaxed font-medium">{pack.deepAnalysis.architecture}</p>
              </div>
            </div>
            ...
            <div className="relative group overflow-hidden rounded-2xl p-[1px]">
              ...
              <div className="glass h-full relative bg-[#050812]/90 border border-violet-500/20 p-5 rounded-2xl hover:bg-violet-500/10 transition-all cursor-default">
                ...
                <p className="text-xs text-slate-300 leading-relaxed font-medium">{pack.deepAnalysis.modernity}</p>
              </div>
            </div>
            ...
            <div className="relative group overflow-hidden rounded-2xl p-[1px]">
              ...
              <div className="glass h-full relative bg-[#050812]/90 border border-emerald-500/20 p-5 rounded-2xl hover:bg-emerald-500/10 transition-all cursor-default">
                ...
                <p className="text-xs text-slate-300 leading-relaxed font-medium">{pack.deepAnalysis.security}</p>
              </div>
            </div>
            ...
            <div className="relative group overflow-hidden rounded-2xl p-[1px]">
              ...
              <div className="glass h-full relative bg-[#050812]/90 border border-amber-500/20 p-5 rounded-2xl hover:bg-amber-500/10 transition-all cursor-default">
                ...
                <p className="text-xs text-slate-300 leading-relaxed font-medium">{pack.deepAnalysis.scalability}</p>
              </div>
            </div>
          </div>
        </Panel>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Panel title="2. Skill Gap vs Role" icon={<Target className={iconClass} />}>
          <div className="space-y-4">
            {pack.roleFits.slice(0, 4).map((role) => (
        ...
        <Panel title="3. Codebase Health" icon={<HeartPulse className={iconClass} />}>
          <div className="mb-5 rounded-xl bg-slate-900/55 border border-slate-800 p-4">
            <div className="flex items-end justify-between">
              ...
              <span className="text-3xl font-black text-white">{pack.codebaseHealth.overall}<span className="text-sm text-slate-500">/100</span></span>
            </div>
            <div className="mt-3"><Meter value={pack.codebaseHealth.overall} color="bg-emerald-500" /></div>
          </div>
          <div className="space-y-3">
            {pack.codebaseHealth.categories.map((category) => (
        ...
        <Panel title="4. Hireability Report" icon={<BriefcaseBusiness className={iconClass} />}>
          <div className="flex items-start gap-4">
            <div className="w-20 h-20 shrink-0 rounded-2xl bg-primary text-slate-950 flex items-center justify-center text-4xl font-black">
              {pack.hireabilityReport.grade}
            </div>
            <div>
              <p className="text-slate-300 leading-relaxed">{pack.hireabilityReport.summary}</p>
              <p className="mt-3 text-sm text-slate-500">Best fits: {pack.hireabilityReport.bestFitRoles.join(', ')}</p>
            </div>
          </div>
          <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
            {pack.hireabilityReport.interviewTalkingPoints.slice(0, 4).map((point) => (
              <div key={point} className="rounded-xl border border-slate-800 bg-slate-900/55 p-3 text-sm text-slate-300">
                {point}
              </div>
            ))}
          </div>
        ...
        <Panel title="7. Explanation Modes" icon={<Sparkles className={iconClass} />}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ['Recruiter', pack.explanations.recruiter],
              ['CTO', pack.explanations.cto],
              ['Peer', pack.explanations.peer],
              ['Beginner', pack.explanations.beginner],
            ].map(([label, text]) => (
              <div key={label} className="rounded-xl border border-slate-800 bg-slate-900/55 p-4">
